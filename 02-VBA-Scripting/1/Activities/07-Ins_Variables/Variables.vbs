Sub Variables():
    ...
    ' The actual concatenation (appending multiple string values to another)
    fullname = name + " " + title 
    ...
    ' Here, we set the value of a cell to whatever is on the right side of our equals sign!
